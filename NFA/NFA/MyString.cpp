...
MyString::MyString(size_t capacity, bool mmemory)
{
	_length = capacity - 1;
...
{
	MyString result(lhs._length + rhs._length + 1,true);
...
MyString::MyString(char ch): MyString(2, true)
{
	_data[0] = ch;
	_data[1] = '\0';
}
